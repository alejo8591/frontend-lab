...
function $ParseProvider() {
   ...
   * dichotomy between data access in includes (accessed as raw values) and controller code
 ...
 * includes.  Refer {@link ng.$sceDelegateProvider#methods_resourceUrlWhitelist
